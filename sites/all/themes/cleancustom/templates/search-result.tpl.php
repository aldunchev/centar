...
<li class="<?php print $classes; ?> views-row col-4 fl-left"<?php print $attributes; ?>>
  ...
  <h3 class="views-field-title"<?php print $title_attributes; ?>>
    <a href="<?php print $url; ?>">
      <?php print views_trim_text(array('max_length' => 20, 'ellipsis' => TRUE), $title); ?>
    </a>
  </h3>
  <div class="views-field-name">
    <span><?php print t('от: ') ?></span>
    <?php print views_trim_text(array('max_length' => 20, 'ellipsis' => TRUE), $author); ?>
  </div>
</li>